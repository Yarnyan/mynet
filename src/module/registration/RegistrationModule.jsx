...
const RegistrationModule = ({ isOpen, toggle }) => {
    ...
    return (
        <>
            ...
            <Modal isOpen={isOpen} toggle={toggle} className={styles.centeredModal} style={{maxWidth: '90%'}}>
                <ModalHeader toggle={toggle}>Регистрация</ModalHeader>
                <ModalBody style={{width: '500px'}}>
                    <form onSubmit={handleSubmit}>
                        <Input required type="text" placeholder="Логин" className={styles.modalInput} style={{width: '500px', marginTop: '15px'}}/>
